def onluga_cevir(deger, taban):
    ...
    rakamlar = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz"
...
kaynak_taban = int(input("Kaynak tabanı giriniz (2-62): "))
hedef_taban = int(input("Hedef tabanı giriniz (2-62): "))

try:

    if kaynak_taban < 2 or kaynak_taban > 62:
        raise ValueError

    if hedef_taban < 2 or hedef_taban > 62:
        raise ValueError
